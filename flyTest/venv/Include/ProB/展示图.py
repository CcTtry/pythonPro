...
plt.ylim(421.15, 421.55)

p2 = plt.plot(x1, y2, color="blue", marker='*', label=ids[2])
p3 = plt.plot(x1, y3, color="orange", marker='.', label=ids[3])
...
plt.legend(p, labs, loc='center right', prop={'family': 'sans-serif', 'size': 16})
